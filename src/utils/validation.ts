...
export const registerSchema = Joi.object({
  ...
  role: Joi.string().valid('ADMIN', 'GESTOR', 'ANALISTA', 'OPERADOR', 'VISUALIZADOR').optional(),
});
...
export const documentQuerySchema = Joi.object({
  ...
  status: Joi.string().valid('PENDENTE', 'PROCESSANDO', 'CONCLUIDO', 'ERRO', 'REJEITADO').optional(),
